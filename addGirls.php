...
<form action ="addGirlsController.php" method = "post">
	...
	<tr>
		...
		<?php if(isset($_GET["lastName"])) echo "<span>*</span>"; ?>Last Name <input type = "text" name = "lastName" style="width:200px" /></td>
	</tr>
	<tr>
		<td><?php if(isset($_GET["address"])) echo "<span>*</span>"; ?>Address <input type = "text" name = "address" style="width:492px" /></td>
	</tr>
	<tr>
		<td><?php if(isset($_GET["city"])) echo "<span>*</span>"; ?>City <input type = "text" name = "city" style = "width:125px" />
